...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (currentUser) {
        ...
        // Bouton Hero Dashboard
        const heroDashBtn = document.querySelector('.btn-hero-dashboard');
        if (heroDashBtn) {
            heroDashBtn.href = 'app/dashboard.html';
        }
    } else {
        // Non connecté : S'assurer que le bouton dashboard renvoie vers le login
        const heroDashBtn = document.querySelector('.btn-hero-dashboard');
        if (heroDashBtn) {
            heroDashBtn.href = 'login.html';
        }
    }
